...
CSRF_COOKIE_HTTPONLY = True  # Prevent JS access to CSRF cookie in production
CSRF_COOKIE_SECURE = True  # Make it secure if using HTTPS
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-fm6!97#=bq=_r#g7r9u)jqg2^0f7vh6zs_))@e*1!a1r$dy1tw'
SIMPLE_JWT = {
